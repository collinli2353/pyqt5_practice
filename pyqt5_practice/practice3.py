...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(20, 20, 471, 311))
        font = QtGui.QFont()
        ...
        ## lambda allows paramater to be inputed ##
        ...
        self.actionPaste.triggered.connect(lambda: self.clicked("Copy clicked"))
